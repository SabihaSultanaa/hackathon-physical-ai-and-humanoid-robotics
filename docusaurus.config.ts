...
const config: Config = {
  ...
  organizationName: 'Sabiha Sultana',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/SabihaSultanaa',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/SabihaSultanaa',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/sabiha-sultana-52abaa222/',
            },
          ],
        },
        {
